...
def main():
    ...
    p.add_argument('--feature-mode',choices=('mfg-only','nr-mfg'))
    p.add_argument('--enable-effects',action='store_true')
    ...
    e=engine_bridge.module(config,provider)
    ...
    print('Options: --runtime-provider y4my|dlss-unlocked --feature-mode mfg-only|nr-mfg --enable-effects')
