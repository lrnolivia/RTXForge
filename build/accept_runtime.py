...
assert meta['policy']=='RTXForge.NrPanel.v1' and 'RTXForge.NativeMfgMenu.v1' in meta['capabilities']
assert b'RTXForge.NativeMfgMenu.v1' in data and b'RTXForge.NrPanel.v1' in data
